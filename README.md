...
**PRINT DO CONSOLE:**
Abaixo está um print do console da Parte I (sem sincronização), onde ocorre a race condition: múltiplas threads verificam assentos ao mesmo tempo e vendem mais do que existe.
